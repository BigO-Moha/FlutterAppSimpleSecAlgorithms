...
class AesUi extends StatefulWidget {
  static const routeName = '/AesUi';
  AesUi({Key key}) : super(key: key);

  @override
  _AesUiState createState() => _AesUiState();
}

class _AesUiState extends State<AesUi> {
  String decrypyingText = '';
  String prevText = '';
  String selected;
              ...
              children: <Widget>[
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      enabled: mode.text == 'encryption' ? true : false,
                      maxLines: 1,
                      keyboardType: TextInputType.emailAddress,
                      controller: text,
                      decoration: InputDecoration(
                        hintStyle: TextStyle(color: Colors.black),
                        hintText: decrypyingText,
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      ...
                      mode.text == 'encryption'
                          ? encrypted = data.encrypt_decrypt(
                              text: text.text,
                              key: key.text.toString(),
                              isEncryption: true)
                          : decrypted = data.encrypt_decrypt(
                              text: prevText,
                              key: key.text.toString(),
                              isEncryption: false);
